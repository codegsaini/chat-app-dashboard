...
export const Sidebar = (
    ...
    return <div className={[css.container, className].join(' ')}>
        {
            true ? (
...
const ChatItem = ({onChatClick, ticketInfo, isActive}) => {
    return <div style={{backgroundColor: isActive ? "#e2e2e2" : "#ffffff"}} onClick={onChatClick} className={css.chat_item}>
        ...
        <div className={css.chat_content}>
            ...
            <p className={css.chat_text}>{ticketInfo?.lastMessage}</p>
